...
code_to_name_doc = {
    ...
    0x80B90000: ('BadResponseTooLarge', 'The response message size exceeds limits set by the my_opcua_client.'),
    ...
    0x800D0000: ('BadServerNotConnected', 'The operation could not complete because the my_opcua_client is not connected to the server.'),
    0x800E0000: ('BadServerHalted', 'The server has stopped and cannot process any requests.'),
    0x800F0000: ('BadNothingToDo', 'There was nothing to do because the my_opcua_client passed a list of operations with no elements.'),
    ...
    0x80260000: ('BadSessionClosed', 'The session was closed by the my_opcua_client.'),
    ...
    0x802C0000: ('BadRequestCancelledByClient', 'The request was cancelled by the my_opcua_client.'),
    ...
    0x80520000: ('BadSempahoreFileMissing', 'The semaphore file specified by the my_opcua_client is not valid.'),
    ...
    0x80580000: ('BadApplicationSignatureInvalid', 'The signature generated with the my_opcua_client certificate is missing or invalid.'),
    0x80590000: ('BadNoValidCertificates', 'The my_opcua_client did not provide at least one software certificate that is valid and meets the profile requirements for the server.'),
    0x80C60000: ('BadIdentityChangeNotSupported', 'The server does not support changing the user identity assigned to the session.'),
    0x805A0000: ('BadRequestCancelledByRequest', 'The request was cancelled by the my_opcua_client with the Cancel service.'),
    ...
    0x805D0000: ('BadNodeIdRejected', 'The requested node id was reject because it was either invalid or server does not allow node ids to be specified by the my_opcua_client.'),
    ...
    0x80760000: ('BadArgumentsMissing', 'The my_opcua_client did not specify all of the input arguments for the method.'),
    ...
    0x807C0000: ('BadInsufficientClientProfile', 'The my_opcua_client of the current session does not support one or more Profiles that are necessary for the subscription.'),
    ...
    0x80A10000: ('BadTimestampNotSupported', 'The my_opcua_client requested history using a timestamp format the server does not support (i.e requested ServerTimestamp when server only supports SourceTimestamp).'),
    ...
    0x80AD0000: ('BadDisconnect', 'The server has disconnected from the my_opcua_client.'),
